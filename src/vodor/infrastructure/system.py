...
from vodor.domain.model import ParsingJob
from vodor.domain.ports import Clock, DomainEventPublisher, ParsingJobRepository
...
class StructuredLoggingEventPublisher(DomainEventPublisher):
    def __init__(self, logger: logging.Logger | None = None) -> None:
        self._logger = logger or logging.getLogger("vodor.events")
